...
def main():
    ...
    # Feature coefficients (top features for each class)
    print("\n" + "="*50)
    print("Top 20 Most Important Features (by coefficient magnitude):")
    print("="*50)
    feature_names = vectorizer.get_feature_names_out()
    # Get coefficients for the positive class (sarcastic)
    ...
    print("Vectorizer saved as 'tfidf_vectorizer_svm.pkl'")
